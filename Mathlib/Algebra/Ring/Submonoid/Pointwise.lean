...
@[instance_reducible]
protected noncomputable def smul : SMul (AddSubmonoid R) (AddSubmonoid A) where
...
@[instance_reducible]
protected noncomputable def mul : Mul (AddSubmonoid R) :=
...
@[instance_reducible]
protected noncomputable def mulOneClass : MulOneClass (AddSubmonoid R) where
...
@[instance_reducible]
protected noncomputable def semigroup : Semigroup (AddSubmonoid R) where
  mul_assoc _M _N _P :=
    le_antisymm
...
@[instance_reducible]
protected noncomputable def monoid : Monoid (AddSubmonoid R) where
