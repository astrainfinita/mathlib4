...
noncomputable irreducible_def nhds (x : X) : Filter X :=
...
noncomputable def nhdsSet (s : Set X) : Filter X :=
  sSup (nhds '' s)
...
noncomputable def Filter.cocompact : Filter X :=
...
noncomputable def Filter.coclosedCompact : Filter X :=
