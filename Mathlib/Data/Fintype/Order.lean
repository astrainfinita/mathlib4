...
variable {α ι ι' : Type*} [Finite ι] [Finite ι'] [PartialOrder α] [ConditionallyCompleteLattice α]
...
variable {α β ι : Type*} [ConditionallyCompleteLinearOrder α] [PartialOrder β] [ConditionallyCompleteLattice β]
  [Finite ι] [Nonempty ι]
